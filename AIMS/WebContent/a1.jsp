...
<h3 style="color:red"><img src="toyota.jpg"  width=150px height=120px></h3>
<div class="container">
 ...
 <div class="form-group row">
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Fortuner</h3>
      <div class="icon">
  <h3><img src="th1.jpg" text-align="center" width=150px height=100px></h3>
  </div>
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Innova</h3>
      <div class="icon">
  <h3><img src="th2.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">corolla Altis</h3>
      <div class="icon">
  <h3><img src="th3.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Liva</h3>
      <div class="icon">
  <h3><img src="th4.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<div class="form-group row">
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Fortuner</h3>
      <div class="icon">
  <h3><img src="tt1.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Innova</h3>
      <div class="icon">
  <h3><img src="tt2.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">corolla Altis</h3>
      <div class="icon">
  <h3><img src="tt3.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Liva</h3>
      <div class="icon">
  <h3><img src="tt4.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<div class="form-group row">
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Music System</h3>
      <div class="icon">
  <h3><img src="ti1.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="icon">
  <h3><img src="ti2.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Seat Cover</h3>
      <div class="icon">
  <h3><img src="ti3.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Window Shade</h3>
      <div class="icon">
  <h3><img src="ti4.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
