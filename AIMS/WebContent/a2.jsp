...
<h3 style="color:red"><img src="isuzu.jpg"  width=200px height=80px></h3>
<div class="container">
 ...
 <div class="form-group row">
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">D-Max</h3>
      <div class="icon">
  <h3><img src="ih1.jpg" text-align="center" width=150px height=100px></h3>
  </div>
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">MU-7</h3>
      <div class="icon">
  <h3><img src="ih2.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">S-Cab</h3>
      <div class="icon">
  <h3><img src="ih3.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
