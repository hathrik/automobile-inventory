...
<h1 style="color:red"><img src="nexa.jpg"  width=200px height=80px></h1>
<div class="container">
 ...
 <div class="form-group row">
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Baleno</h3>
      <div class="icon">
  <h3><img src="head1.jpg" text-align="center" width=150px height=100px></h3>
  </div>
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Ciaz</h3>
      <div class="icon">
  <h3><img src="head4.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">S-Cross</h3>
      <div class="icon">
  <h3><img src="head2.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Ignis</h3>
      <div class="icon">
  <h3><img src="head3.jpg" text-align="center" width=100px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
...
<div class="form-group row">
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Baleno</h3>
      <div class="icon">
  <h3><img src="slide1.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
