...
<h1 style="color:red"><img src="honda.jpg"  width=130px height=100px></h1>
<div class="container">
 ...
 <div class="form-group row">
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">BR-V</h3>
      <div class="icon">
  <h3><img src="head3.jpg" text-align="center" width=150px height=100px></h3>
  </div>
...
<button type="submit" class="btn btn-default" form="form1"><span class="glyphicon glyphicon-shopping-cart"> Add to Cart</button>
      ...
      <div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">Accord</h3>
      <div class="icon">
...
<div class="col-xs-3">
        <form id="form1">
          <h3 style="color:white">City</h3>
      <div class="icon">
  <h3><img src="tail4.jpg" text-align="center" width=150px height=100px></h3>
  </div>
  <div class="form-group">
    <label for="exampleInputName" style="color:red">Quantity</label>
    <input type="number" class="form-control" id="exampleInputName" min="10" max="100">
